  ...
  return (
    <main className="main-container">
      ...
      <div className="section-flex border border-red-300 p-4">
        ...
        />
        <p className="text-lg text-red-500">Atenção: Este site tem propósito educativo. Todos os dados exibidos neste site (cães, endereço, e-mail e telefone) são fictícios. Portanto, ao enviar os seus dados no formulário, nenhum dado foi salvo.</p>
      </div>
